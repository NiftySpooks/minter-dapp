const contractAddress = "0x69A08a31dD33bA29a9b06B22D846467c7e2bCdbC"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Nifty Spooks NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Nifty Spooks NFT Project is a decentralized, open-source project that aims to provide you with amazing PFPs.';
